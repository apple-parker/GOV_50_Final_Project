...
```{r}
# Create a bar chart of population density by county
ggplot(population_density, aes(x = reorder(county_name, -density), y = density)) +
  geom_bar(stat = "identity") +
  scale_y_log10() +
  theme_minimal() +
  labs(title = "Population Density by County in Utah",
       x = "County",
       y = "Pop. Density (per sq. mile, log scale)") +
